...
[![GitHub release](https://img.shields.io/github/v/release/arnavpisces/opencode-sidebar)](https://github.com/arnavpisces/opencode-sidebar/releases)
...
- GitHub releases: https://github.com/arnavpisces/opencode-sidebar/releases
- Release assets include the packed npm tarball for each tagged GitHub release
...
To publish a GitHub release for the current package version:
...
- run `npm ci`
- run `npm run verify`
- build an `npm pack` tarball
- create a GitHub release with autogenerated notes and attach the tarball

This workflow does not publish to npm. npm publishing remains manual.
